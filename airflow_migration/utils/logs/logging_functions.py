...
class AirflowLogger:
    ...
    def log_task_success(self, task_id: str, dag_id: str, execution_time: Optional[float] = None):
        """
    ...
    def log_task_failure(self, task_id: str, dag_id: str, exception: Optional[Exception] = None):
        """
    ...
    def log_xcom_pull(self, key: str, task_id: str, success: bool = True):
        ...
        self.info(
            f"XCom pull {status}", 
            {"xcom_key": key, "task_id": task_id}
        )
    
    def log_database_operation(self, operation: str, table: str, affected_rows: Optional[int] = None):
        """
    ...
    def log_api_call(self, endpoint: str, method: str = "GET", status_code: Optional[int] = None):
        """
        Log API calls.
