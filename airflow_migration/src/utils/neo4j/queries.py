...
CREATE_INDEX_SCHOOL_GEOGRAPH = (
    "CREATE INDEX IF NOT EXISTS FOR (g:SchoolGeograph) ON (g.id)"
)
CREATE_INDEX_STUDENT_DISCIPLINE = (
    "CREATE INDEX IF NOT EXISTS FOR (sd:StudentDiscipline) ON (sd.id)"
)
...
CREATE_INDEX_STUDENT_CLASS = (
    "CREATE INDEX IF NOT EXISTS FOR (sc:StudentClass) ON (sc.id)"
)
