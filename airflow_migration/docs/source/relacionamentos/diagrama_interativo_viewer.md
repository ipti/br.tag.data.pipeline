# Diagrama ER Completo (Estilo DBeaver)

Este diagrama mostra todas as tabelas com suas colunas e relacionamentos de chaves estrangeiras.
...
### Cores (se suportado pelo viewer)

* **Azul** : Tabelas Dimensão (D_*)
* **Laranja** : Tabelas Fato (F_*)
* **Cinza** : Outras Tabelas
